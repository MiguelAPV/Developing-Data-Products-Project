...
shinyServer(function(input, output, session) {
  consumer_key <- "V5i5aDOP4OUviDN9bdaq9OJ5a" # Enter your consumer key
  consumer_secret <- "VjppH2eqTrRMGppp1OAGkfegkSI4arkv4bOzuSovRt6dkbRrmK" # Enter your consumer secret
  access_token <- "102812610-PhBtqlvB4355n3U8KDMBd2dV1I1HH8hqceV3cOh2" # Enter your access token
  access_secret <- "OrllLDcue96uK0oKsyNOaopwtiEnhMctdh1R1guJNY7pt" # Enter your access secret
  ...
  pos.words = scan('C:/Users/migue/Desktop/DATA Cleaned TESIS/positive_words.txt', what='character', comment.char=';') #Provide your path to "positive_words.txt" file
  neg.words = scan('C:/Users/migue/Desktop/DATA Cleaned TESIS/negative_words.txt', what='character', comment.char=';') #Provide your path to "negative_words.txt" file
